...
def optimization_tou(number_ev):
    ### SETS ###
    tempo = np.arange(288)
    ...
    with open(r"C:\Users\kaioh\Documents\Universidade\TCC\Python\Input\LoadShape48h_DemMed.csv", newline='') as f:
    ...
    ### SOLVER - GLPK ###
    prob.solve(solver=pl.GLPK_CMD(msg=True))
    ...
    path_custo = rf"C:\Users\kaioh\Documents\Universidade\TCC\Python\Comparison\Coordinated_Charging_TOU\custo_{number_ev}.txt"     
...
# total_power_9, ev_power9, soc9, voltages_9, buses_9 = optimization_tou(9)
# total_power_27, ev_power27, soc27, voltages_27, buses_27 = optimization_tou(31)
total_power_44, ev_power44, soc44, voltages_44, buses_44 = optimization_tou(44)
...
# plt.grid(True)
# plt.tight_layout()
# plt.savefig(rf"C:\Users\kaioh\Documents\TCC\Python\Comparison\Coordinated_Charging_TOU\Curva_de_Carga_Artigo.svg")
# plt.close()
...
#     plt.grid(True)
#     plt.tight_layout()
#     plt.savefig(rf"C:\Users\kaioh\Documents\TCC\Python\Comparison\Coordinated_Charging_TOU\Curva_de_Tensão_{barra}")
#     plt.close()
...
#     plt.tight_layout()
#     plt.savefig(rf"C:\Users\kaioh\Documents\TCC\Python\Comparison\Coordinated_Charging_TOU\Charging_Power_SOC_Optimized_Car_Artigo"+ f"{i+1}.png")
#     plt.savefig(rf"C:\Users\kaioh\Documents\TCC\Python\Comparison\Coordinated_Charging_TOU\Charging_Power_SOC_Optimized_Car_Artigo"+ f"{i+1}.svg")
#     plt.close()
...
#     plt.grid(True)
#     plt.tight_layout()
#     plt.savefig(rf"C:\Users\kaioh\Documents\TCC\Python\Comparison\Coordinated_Charging_TOU\Voltages\Perfil_de_Tensão_{buses_9[int(j/3)]}.png")
#     plt.savefig(rf"C:\Users\kaioh\Documents\TCC\Python\Comparison\Coordinated_Charging_TOU\Voltages\Perfil_de_Tensão_{buses_9[int(j/3)]}.svg")
#     plt.close()